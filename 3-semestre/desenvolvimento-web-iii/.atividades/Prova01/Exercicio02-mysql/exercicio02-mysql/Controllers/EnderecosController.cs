...
namespace exercicio02_mysql.Controllers
{
    public class EnderecosController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Enderecos.Include(e => e.Usuario);
        ...
        public async Task<IActionResult> Create([Bind("EnderecoId,Logradouro,Numero,CEP,UsuarioId")] Endereco endereco)
        {
            ...
            ViewData["UsuarioId"] = new SelectList(_context.Usuarios, "UsuarioId", "Nome", endereco.UsuarioId);
            return View(endereco);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("EnderecoId,Logradouro,Numero,CEP,UsuarioId")] Endereco endereco)
        {
