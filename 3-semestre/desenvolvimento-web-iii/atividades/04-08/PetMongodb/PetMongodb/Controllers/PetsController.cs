...
namespace PetMongodb.Controllers
{
    ...
    public class PetsController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id,[Bind("Nome,Idade,Raca,CorPredominante, CorOlhos, Especie, Genero, Porte, Local, PontoReferencia, Data, IdUsuario, Situacao, Recompensa, Comentario")] string imagemAtual, Pet pet, IFormFile? Imagem)
        {
            if (id != pet.Id)
            {
                return NotFound();
