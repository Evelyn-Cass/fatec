...
namespace School.Controllers
{
    public class DisciplinesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("DisciplineId,Name,Duration,CourseId")] Discipline discipline)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("DisciplineId,Name,Duration,CourseId")] Discipline discipline)
        {
